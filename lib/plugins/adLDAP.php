...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@ad.woodmenvalley.org";
    ...
    * @var string
    */
	protected $baseDn = "DC=org,DC=woodmenvalley,DC=ad"; 
    ...
    * @var array
    */
    protected $domainControllers = array("pdc01rr.woodmenvalley.org,pdc02rr.woodmenvalley.org");
    ...
    * @var string
    */
	protected $adminUsername = 'mbaylor';
    protected $adminPassword = 'Iambr0ken!';
